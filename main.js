...
loadExternalScript('https://cdn.jsdelivr.net/npm/three@0.77.1/build/three.min.js', function() {
    console.log('three.js loaded!');
    // Initialize WebXR or other features here after loading the script
    startXR();
});
