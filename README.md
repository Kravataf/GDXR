...
Then once opened go to ```File > Clone repository > URL``` and paste in ```https://github.com/Kravataf/GDXR``` to clone the repository so you can do PRs and the other stuff..
