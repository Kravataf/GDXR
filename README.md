...
Then once opened go to ```File``` > ```Clone repository``` then select ```URL``` where you paste in ```https://github.com/Kravataf/GDXR``` to clone the repository so you can do PRs or other stuff..
